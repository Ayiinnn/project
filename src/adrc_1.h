...
typedef struct ADRC_Parameter
{
	...
	float r=0;//时间尺度1111111111111111111111111111111111111111111111111
	float h=0;//ADRC系统积分时间22222222222222222222222222222222222222222222
	...
	/*********第一种组合形式*********/
	float beta_0=0;//线性
	float beta_1=0;//非线性组合参数444444444444444444444444444444444444444444444444444444
	float beta_2=0;//u0=beta_1*e1+beta_2*e2+(beta_0*e0);555555555555555555555555555555555555555555555555555555555555
	/*********第二种组合形式*********/
	float alpha0=0;
	float alpha1=0;//u0=beta_1*fal(e1,alpha1,zeta)+beta_2*fal(e2,alpha2,zeta)
	float alpha2=0;//0<alpha1<1<alpha2
	float zeta=0;//线性段的区间长度3333333333333333333333333333333333333333333333333333333
	/*********第三种组合形式*********/
